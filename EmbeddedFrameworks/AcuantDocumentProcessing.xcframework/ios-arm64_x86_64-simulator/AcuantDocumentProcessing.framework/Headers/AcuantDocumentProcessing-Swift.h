...
@property (nonatomic, strong) ClassificationDetails * _Nullable classificationDetails;
...
@property (nonatomic, strong) Type * _Nullable front;
@property (nonatomic, strong) Type * _Nullable back;
+ (ClassificationDetails * _Nullable)initWithJsonObjectWithJsonDict:(NSDictionary<NSString *, id> * _Nullable)jsonDict SWIFT_METHOD_FAMILY(none) SWIFT_WARN_UNUSED_RESULT;
