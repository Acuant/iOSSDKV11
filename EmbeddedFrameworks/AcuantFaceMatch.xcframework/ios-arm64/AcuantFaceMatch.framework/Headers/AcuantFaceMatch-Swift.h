...
#ifndef ACUANTFACEMATCH_SWIFT_H
#define ACUANTFACEMATCH_SWIFT_H
...
SWIFT_CLASS("_TtC15AcuantFaceMatch9FaceMatch")
@interface FaceMatch : NSObject
+ (void)processFacialMatchWithFacialData:(FacialMatchData * _Nonnull)facialData delegate:(id <FacialMatchDelegate> _Nonnull)delegate;
...
@property (nonatomic, strong) UIImage * _Nonnull faceImageOne;
@property (nonatomic, strong) UIImage * _Nonnull faceImageTwo;
- (nonnull instancetype)initWithFaceImageOne:(UIImage * _Nonnull)faceImageOne faceImageTwo:(UIImage * _Nonnull)faceImageTwo OBJC_DESIGNATED_INITIALIZER;
+ (FacialMatchData * _Nonnull)newInstanceWithFaceImageOne:(UIImage * _Nonnull)faceImageOne faceImageTwo:(UIImage * _Nonnull)faceImageTwo SWIFT_WARN_UNUSED_RESULT;
...
+ (FacialMatchResult * _Nonnull)initWithJSONDictWithJsonDict:(NSDictionary<NSString *, id> * _Nullable)jsonDict SWIFT_METHOD_FAMILY(none) SWIFT_WARN_UNUSED_RESULT;
