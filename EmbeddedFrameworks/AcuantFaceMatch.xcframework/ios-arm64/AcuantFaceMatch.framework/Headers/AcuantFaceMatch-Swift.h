...
@property (nonatomic, copy) NSData * _Nonnull faceOneData;
@property (nonatomic, copy) NSData * _Nonnull faceTwoData;
- (nonnull instancetype)initWithFaceOneData:(NSData * _Nonnull)faceOneData faceTwoData:(NSData * _Nonnull)faceTwoData OBJC_DESIGNATED_INITIALIZER;
+ (FacialMatchData * _Nonnull)newInstanceWithFaceOneData:(NSData * _Nonnull)faceOneData faceTwoData:(NSData * _Nonnull)faceTwoData SWIFT_WARN_UNUSED_RESULT;
