...
#ifndef ACUANTIPLIVENESS_SWIFT_H
#define ACUANTIPLIVENESS_SWIFT_H
...
SWIFT_CLASS("_TtC16AcuantIPLiveness10IPLiveness")
@interface IPLiveness : NSObject
...
+ (void)getLivenessTestCredentialWithDelegate:(id <LivenessTestCredentialDelegate> _Nonnull)delegate;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

typedef SWIFT_ENUM(NSInteger, IpFilter, open) {
  IpFilterClassic = 0,
  IpFilterShaded = 1,
  IpFilterVibrant = 2,
};
...
@property (nonatomic, copy) NSString * _Nonnull apiEndpoint;
@property (nonatomic, strong) LivenessUiOptions * _Nonnull ui;
- (nonnull instancetype)initWithApiKey:(NSString * _Nonnull)apiKey token:(NSString * _Nonnull)token userId:(NSString * _Nonnull)userId apiEndpoint:(NSString * _Nonnull)apiEndpoint OBJC_DESIGNATED_INITIALIZER;
+ (LivenessSetupResult * _Nonnull)createInstanceWithApiKey:(NSString * _Nonnull)apiKey token:(NSString * _Nonnull)token userId:(NSString * _Nonnull)userId apiEndpoint:(NSString * _Nonnull)apiEndpoint SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_PROTOCOL("_TtP16AcuantIPLiveness30LivenessTestCredentialDelegate_")
@protocol LivenessTestCredentialDelegate
- (void)livenessTestCredentialReceivedWithResult:(BOOL)result;
- (void)livenessTestCredentialReceiveFailedWithError:(AcuantError * _Nonnull)error;
@end
...
- (void)livenessTestConnecting;
- (void)livenessTestConnected;
...
@property (nonatomic, weak) id <IProovPresentationDelegate> _Nullable delegate;
