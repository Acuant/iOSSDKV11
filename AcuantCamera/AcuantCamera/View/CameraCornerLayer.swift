...
public class CameraCornerLayer: CALayer {
    ...
    public init(bracketLengthInHorizontal: Int,
                bracketLengthInVertical: Int,
                defaultBracketMarginWidth: CGFloat,
                defaultBracketMarginHeight: CGFloat) {
